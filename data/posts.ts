...
export const posts: Post[] = [
  ...
  },
  {
    ...
    formato: "Carrossel",
    pilar: "Estratégia",
    card: "Conta de investimento no nome do filho menor de idade. Por que eu sempre desaconselho.",
    slides: [
      "Conta de investimento no nome do filho menor de idade. Por que eu sempre desaconselho.",
      "A intenção é ótima. Começar cedo é o que mais funciona em investimento.",
      "Mas tem um ponto central: controle.",
      "Aos 18 anos, essa pessoa passa a ter controle total sobre o patrimônio. E a gente não sabe quem ela vai ser aos 18.",
      "A chance de dar errado é baixa. Não é a tendência. Mas ela existe — e aos 18 você não tem como barrar.",
      "Sem contar que 18 anos é cedo. A visão de mundo ainda está em construção.",
