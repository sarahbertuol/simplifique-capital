...
export const posts: Post[] = [
  ...
  },
  {
    ...
    slides: [
      "E se investir bem fosse muito mais simples do que você imagina?",
      "Você não precisa acompanhar o mercado todos os dias.",
      "Não precisa tentar prever a próxima crise.",
